    ...
    <div className="h-screen min-h-screen flex bg-white">
      ...
      <main className="w-full flex flex-col">
          ...
          {user && (
            <div className="ml-auto mr-6">
              <button
                aria-describedby={id}
                onClick={handleClick}
                className="flex items-center justify-center bg-blue-10 h-12 w-12 rounded-full"
              >
        ...
        <div className="flex flex-1 flex-col items-center">
          <h1 className="text-dark_blue-100 text-3xl font-semibold tracking-[-1px]">
            Create a Fund
          </h1>
          ...
          <div className="flex flex-col flex-1 items-center p-6 mt-6">
            {user ? (
              <div className="bg-light-100 p-6 rounded-[40px] h-56 flex flex-col items-center">
                <h3 className="text-dark_blue-100 text-2xl font-semibold text-center leading-8">
                  Create a Fund
                </h3>
                <p className="text-dark_blue-80 text-center leading-6">
                  Simply create a fund, copy and share the link with your
                  friends to start collecting!
                </p>
                ...
                <div className="flex flex-1 justify-center items-end">
                  ...
                  <button
                    onClick={() => {
                      fetch("/api/funds", {
                        method: "POST",
                        body: JSON.stringify({ name: "Fund 1" }),
                        headers: {
                    ...
                    className="flex justify-center items-center focus:outline-none focus:shadow-none"
                  >
                    ...
                    <span className="text-blue-100 font-medium leading-7 tracking-[-0.4px]">
                      Add
                    </span>
                  </button>
                  {/* </Link> */}
              ...
              <div className="bg-blue-100 p-6 rounded-[40px] h-56 flex flex-col items-center mb-5 w-full">
                <h3 className="text-white text-2xl font-semibold text-center leading-8 mb-1">
                  Already have a fund.
                </h3>
                <p className="text-white-80 text-center leading-6 text-sm tracking-[-0.3px] px-1">
                  Login to track fund progress, see contributors and other
                  information.
                </p>
                ...
                <div className="flex flex-1 justify-center items-end">
                  <Link href="/api/auth/login">
                    <button className="flex justify-center items-center">
                      ...
                      <span className="text-white font-medium leading-7 tracking-[-0.4px]">
                        Login
                      </span>
                    </button>
                  </Link>
