...
func (l *Logger) logEvent(msg string, fields logrus.Fields) {
	l.Logger.WithFields(fields).Log(logrus.InfoLevel, msg)
}

func (l *Logger) logError(msg string, fields logrus.Fields) {
...
func (*Logger) String() string { return "AppLogger" }
